...
export default function AddModal() {
    ...
    return <div className='w-full h-screen absolute flex flex-col items-center justify-center top-0 left-0 z-50 overflow-hidden px-10 py-5 text-gray-200 bg-gray-700/95 space-y-5'>
